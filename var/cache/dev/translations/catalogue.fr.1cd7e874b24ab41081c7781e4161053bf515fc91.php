...
$catalogue = new MessageCatalogue('fr', array (
  ...
  'messages' => 
  array (
    'login.wrong_credentials' => 'Username et/ou Mot de Passe non valide!',
    'field.too_short' => 'Cet champ est requis!',
    'note' => 'Connectez vous a votre Compte',
    'tip' => 'ASTUCE',
    'action.success_in' => 'Success Distributeur creer!',
    ...
    'action.validate_in' => 'Validater',
    'action.welcome_in' => 'Bienvenu(e)',
    'action.user_nber' => 'Numéro ID',
    'action.status_in' => 'Vous etez désormais',
    'action.period_in' => 'La période de commission prendra fin dans',
    'action.days_in' => '21 Jours 10 Heures 25 Minutes',
    'action.register_in' => 'Préinscrire un nouvel distributeur',
    'action.comp_in' => 'Découvrez l’exceptionnel pouvoir de compensation de notre marketing de réseau, en construisant votre équipe',
    'action.fullname_in' => 'Nom(s) complet(s)',
    'action.name_in' => 'Prénom(s) complet(s)',
    'action.birth_in' => 'Date de naissance',
    'action.phone_in' => 'N° de Téléphone',
    'action.country_in' => 'Pays',
    'action.city_in' => 'Ville',
    'action.address_in' => 'Adresse complète',
    'label.password.confirm' => 'Confirmer Mot de Passe',
    'label.email.confirm' => 'Confirmer Email',
    'label.email' => 'Email',
    'label.kits' => 'Trousse de démarrage',
    'action.dashboard_in' => 'TABLEAU DE BORD',
    'action.network_in' => 'RESEAU',
